"""11. Movimento limitato ai bordi
Crea un personaggio che può essere 
mosso, ma non può uscire dai bordi 
della finestra. Se raggiunge un bordo, 
la velocità deve azzerarsi."""
