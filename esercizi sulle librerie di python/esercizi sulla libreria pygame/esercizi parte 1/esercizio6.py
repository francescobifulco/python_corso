"""6. Cambiare velocità tramite tastiera
Permetti all’utente di aumentare o 
diminuire la velocità del punto usando 
i tasti + e –. Impedisci che la velocità 
diventi negativa."""
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == pygame.KEYDOWN:
            if evento.key == pygame.K_PLUS or evento.key == pygame.K_KP_PLUS:
                ...
                if cerchio_vel > 20:
                    cerchio_vel = 19
                    print("Velocità massima superata")
